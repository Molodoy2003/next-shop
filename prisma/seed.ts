...
/*
  в этом файле просто генерируем данные
  up - генерирует данные
  down - чистит данные
*/
...
async function up() {
  ...
  const pizza1 = await prisma.product.create({
    data: {
      ...
      imageUrl:
        'https://media.dodostatic.net/image/r:292x292/11EE7D5F023926BABE8370E126C19685.avif',
      categoryId: 1,
      ingredients: {
  ...
  const pizza2 = await prisma.product.create({
    data: {
      name: 'Деревенская',
      imageUrl:
        'https://media.dodostatic.net/image/r:292x292/11EE7D5EEAB632F58FA9238A2CC13BBB.avif',
      categoryId: 1,
      ingredients: {
